  ...
  return (
    <div className="pt-32 pb-20">
      <div className="container-custom">
        ...
        <section
          id="contact"
          className="bg-primary-50 border border-primary-200/60 rounded-xl p-8 md:p-10 scroll-mt-24"
        >
          ...
          <div className="space-y-2 text-warm-700 text-[0.95rem]">
            <p>
              <span className="font-semibold">Address:</span>{' '}
              <span className="text-warm-500">Edit with your organisation&apos;s address</span>
            </p>
            <p>
              <span className="font-semibold">Phone:</span>{' '}
              <span className="text-warm-500">Edit with your contact number</span>
            </p>
            <p>
              <span className="font-semibold">Email:</span>{' '}
              <span className="text-warm-500">Edit with your email address</span>
            </p>
          </div>
        </section>
      </div>
